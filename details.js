...
async function detalharProduto() {
  ...
  container.innerHTML = `
    <div class="row">
      <div class="col-md-6">
        <img src="${produto.imgScr}" class="rounded float-left" alt="..." style="width: 500px; height: 500px;" >
      </div>
      <div class="col-md-4">
        <div class="row">
          <p class="h2"> ${produto.title} </p>
          <div class="ml-1 mr-1">
            <i class="bi bi-suit-heart" style="width: 30px; height: 30px;"></i>
            <i class="bi bi-arrows-angle-expand" style="width: 30px; height: 30px;"></i>
          </div>
          <p> ${produto.text} </p>
          <p> ${produto.textDesc} </p>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="row mt-1">
              <a href="carrinho.html"> <button type="button" class="btn btn-info btn-primary medio"> Adicionar ao carrinho </button> </a>                    
            </div> 
          </div>               
        </div>
      </div>
